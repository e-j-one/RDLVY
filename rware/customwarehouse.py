...
class Agent(Entity):
    ...
    # WTD: Update self.line_dir if Action.Left->Action.Left or Action.Right->Action.Right
    # not yet implemented
...
class CustomWarehouse(gym.Env):
    ...
    def __init__(
        ...
        # pickup_places should be fixed: not yet implemented
        ...
        for y, line in enumerate(lines):
            for x, char in enumerate(line):
                ...
                if char.lower() == "g":
                    ...
                    self.highways[y, x] = 1
                    self.highways_status[y, x, :] = Line_Status.EMPTY 
                # for fixed pickup_points: not yet implemented
                # elif char == "p":
